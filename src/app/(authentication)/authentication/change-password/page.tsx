...
// // Define the validation schema without `as const`
// const validationSchema = z.object({
//   oldPassword: z.string().min(6, "Please enter a valid password"),
//   newPassword: z.string().min(6, "Password must be at least 6 characters"),
// });
...
// // Simplify TMargeType to make fields optional using Partial
// type TMargeType = Partial<FormValues>;

// const ChangePasswordPage = () => {
//   const router = useRouter();
//   const [changePassword] = useChangePasswordMutation();

//   // Type assertion for `values` to bypass type constraints in `handleChangePassword`
//   const handleChangePassword: SubmitHandler<FieldValues> = async (
//     values,
//     event
//   ) => {
...
//     const toastId = toast.loading("Please wait...");
//     try {
//       const res = await changePassword(values as TMargeType).unwrap();
//       toast.success(res?.message, { id: toastId, duration: 5000 });
//       logOutUser();
//       router.push("/login");
//     } catch (err: any) {
