...
const FormsTable = () => {
  ...
  const path = "/dashboard/dev_super_admin/content/others/forms/update";
  ...
  const columns: GridColDef[] = [
    { field: "index", headerName: "SERIAL", width: 100 },
    {
      ...
      renderCell: (params) => (
        <Box
          component={Link}
          href={`/dashboard/dev_super_admin/content/others/forms/details/${params?.row?.id}`}
          sx={{
            ":hover": {
    ...
    <Box sx={{ p: 2 }}>
      <Grid container spacing={2}>
        ...
        <Grid size={4}>
          <Button
            component={Link}
            href={"/dashboard/dev_super_admin/content/others/forms/create"}
            sx={{
              maxHeight: "40px",
              width: {
                xs: "100%",
