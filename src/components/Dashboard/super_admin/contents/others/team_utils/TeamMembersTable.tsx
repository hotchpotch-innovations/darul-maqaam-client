...
const TeamMembersTable = () => {
  ...
  const path = "/dashboard/super_admin/content/others/team/update";
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Box
          component={Link}
          href={`/dashboard/super_admin/content/others/team/details/${params?.row?.id}`}
          sx={{
            ":hover": {
    ...
    <Box sx={{ p: 2 }}>
      <Grid container spacing={2}>
        ...
        <Grid size={4}>
          <Button
            component={Link}
            href={"/dashboard/super_admin/content/others/team/create"}
            sx={{
              maxHeight: "40px",
              width: {
                xs: "100%",
